...
ActiveRecord::Schema.define(version: 20170522170137) do
  ...
  add_index "meals", ["attendee_id", "date", "meal_type"], name: "index_meals_on_attendee_id_and_date_and_meal_type", unique: true, using: :btree
  ...
  create_table "people", force: :cascade do |t|
    ...
    t.datetime "conference_status_changed_at", precision: 6
  end
  ...
  add_foreign_key "cost_code_charges", "cost_codes"
  add_foreign_key "housing_facilities", "cost_codes"
  add_foreign_key "ministries", "ministries", column: "parent_id"
  add_foreign_key "people", "seminaries"
  add_foreign_key "stays", "housing_units"
