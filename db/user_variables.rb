class SeedUserVariables
  RECORDS = {
    ...
    # Childcare Weekly Costs (OLD METHOD)
    ...
    # Jr/Sr Weekly Costs (CruStu) (NEW)
    junior_senior_week_4: { value_type: :money, code: :JRSRWKSC, value: 1_00, description: 'CruStu tuition during Staff Conference' },

    # Hot Lunches (OLD METHOD)
