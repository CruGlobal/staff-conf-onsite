module Import
  class Person # rubocop:disable Metrics/ClassLength
    ...
    SPREADSHEET_TITLES = {
      ...
      allergies: 'Forms CC MH Allergy Multi',
      medi_allergy: 'Forms CC MH Med Allergy',
      ...
      vip_developmental_age: 'Forms CS VIP child_dev_age',
      ...
      restriction_certified: 'Forms CC MH Certify',
      ...
      med_allergy_multi: 'Forms CS MH Allergy Multi',
